...
class  Showtehrep(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(35, 21, 931, 401))
        self.tableWidget.setColumnCount(12)
        self.tableWidget.setHorizontalHeaderLabels(['Num', 'Date_of_delivery_for_repair', 'Repair_period', 'Type_of_repair', 'Date_of_transfer', 'FIO_Employee_passed_repair', 'Num_EPR', 'FIO_Employee_accepted_repair', 'Num_EAR', 'Position_of_repair_person', 'Teh_Inv_num', 'Teh_Div_num'])
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setAlternatingRowColors(True)
        self.tableWidget.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.Stretch)

        self.btn_abrirbd2 = QtWidgets.QPushButton(self.centralwidget)
        self.btn_abrirbd2.setGeometry(QtCore.QRect(340, 460, 275, 23))
