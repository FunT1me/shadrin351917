...
class Backup(object):
    ...
    def change(self):
        ...
        try:
            backups_num = int(self.lineEdit.text())
            backups_date = self.lineEdit_2.text()
            backups_versional = self.lineEdit_3.text()
        except:
            return
    ...
    def dels(self):
        ...
        try:
            ...
            return
        cur.execute("DELETE FROM backups WHERE backups_num = %s",(int(ids),))
        db.commit()
        cur.close()
        db.close()
